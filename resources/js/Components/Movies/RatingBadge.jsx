const RatingBadge = ({ rating }) => {
    ...
    return (
        <div
            className={`flex text-xs sm:h-16 sm:w-16 h-12 w-12 flex-col justify-center items-center sm:py-2 rounded-full sm:rounded-lg sm:text-sm font-bold ${getRatingStyle(rating)}`}
        >
            <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="lg:size-5 hidden sm:block"
            >
                <path
                    strokeLinecap="round"
            ...
            <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-3 sm:hidden block"
            >
                <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
